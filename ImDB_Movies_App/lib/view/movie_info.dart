...
class _MovieInfoViewState extends State<MovieInfoView> {
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _buildTitle(),
                  SizedBox(height: 15),
                  StarRatingBar(rating: "${Random().nextInt(5)}"),
                  SizedBox(height: 20),
                  _buildInfoRow(),
                  SizedBox(height: 5),
                  // _buildCrewDetails(),
  ...
  Row _buildInfoRow() {
    return Row(
      ...
      children: [
        _buildInfoItem(tag: "Year", property: randomBetween(1700, DateTime.now().year).toString()),
        // _buildInfoItem(tag: "Rank", property: widget.movie.rank!.toString()),
        _buildInfoItem(
          tag: "Rating",
          property: Random().nextInt(5).toString(),
          addPreStar: true,
        ),
      ],
    );
